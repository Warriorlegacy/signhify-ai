...
class ChatViewProvider {
    ...
    async sendCodeAction(action, code, fileName) {
        const prompts = {
        ...
        const prompt = prompts[action] || `Analyze this code from ${fileName}:\n\n${code}`;
    ...
    _updateWebviewStreaming(partial, agentType) {
        if (this._view) {
            this._view.webview.postMessage({
                type: "streaming",
                content: partial,
